#---
#title: OSCER_3sp_CST_models_20240908
...
for (i in 1:nrow(params_combo_3sp)) {
  ...
  psi_ab<- exp(lambda*(1 - params_combo_3sp[i, 1]))
  psi_ac<- exp(lambda*(1 - params_combo_3sp[i, 2]))
  psi_bc<- exp(lambda*(1 - params_combo_3sp[i, 3]))
...
SILIeq_params_df_3sp$lat_dur<- 1/SILIeq_params_df_3sp$epsilon
...
save.image('OSCER_3sp_CST_models_20240916.Rdata')
