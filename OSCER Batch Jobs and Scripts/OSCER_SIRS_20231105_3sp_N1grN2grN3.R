#---
#title: OSCER_SIRS_20231105_3sp_N1grN2grN3
...
SIRSeq_params_df_3spSHORT_N1grN2grN3<- data.frame(SIRSeq_df, params_combo_3sp_short)

#make ips and imm_durs/latency, and %relatedness, and beta categorical for equilibrium datasets
SIRSeq_params_df_3spSHORT_N1grN2grN3$ips<- 1/SIRSeq_params_df_3spSHORT_N1grN2grN3$gamma

SIRSeq_params_df_3spSHORT_N1grN2grN3$ips_cat<- round(SIRSeq_params_df_3spSHORT_N1grN2grN3$ips)

SIRSeq_params_df_3spSHORT_N1grN2grN3$ips_cat[SIRSeq_params_df_3spSHORT_N1grN2grN3$ips_cat == 7]<- '7 days infectious'
SIRSeq_params_df_3spSHORT_N1grN2grN3$ips_cat[SIRSeq_params_df_3spSHORT_N1grN2grN3$ips_cat == 5]<- '5 days infectious'
SIRSeq_params_df_3spSHORT_N1grN2grN3$ips_cat[SIRSeq_params_df_3spSHORT_N1grN2grN3$ips_cat == 3]<- '3 days infectious'


SIRSeq_params_df_3spSHORT_N1grN2grN3$imm_dur<- 1/SIRSeq_params_df_3spSHORT_N1grN2grN3$epsilon

SIRSeq_params_df_3spSHORT_N1grN2grN3$imm_dur_cat<- round(SIRSeq_params_df_3spSHORT_N1grN2grN3$imm_dur)

SIRSeq_params_df_3spSHORT_N1grN2grN3$imm_dur_cat[SIRSeq_params_df_3spSHORT_N1grN2grN3$imm_dur_cat == 90]<- '90 days immune'
SIRSeq_params_df_3spSHORT_N1grN2grN3$imm_dur_cat[SIRSeq_params_df_3spSHORT_N1grN2grN3$imm_dur_cat == 60]<- '60 days immune'
SIRSeq_params_df_3spSHORT_N1grN2grN3$imm_dur_cat[SIRSeq_params_df_3spSHORT_N1grN2grN3$imm_dur_cat == 30]<- '30 days immune'


SIRSeq_params_df_3spSHORT_N1grN2grN3$psi_ab_perc<- SIRSeq_params_df_3spSHORT_N1grN2grN3$psi_ab*100
SIRSeq_params_df_3spSHORT_N1grN2grN3$psi_ac_perc<- SIRSeq_params_df_3spSHORT_N1grN2grN3$psi_ac*100
SIRSeq_params_df_3spSHORT_N1grN2grN3$psi_bc_perc<- SIRSeq_params_df_3spSHORT_N1grN2grN3$psi_bc*100


SIRSeq_params_df_3spSHORT_N1grN2grN3$beta<- as.character(SIRSeq_params_df_3spSHORT_N1grN2grN3$beta)
SIRSeq_params_df_3spSHORT_N1grN2grN3$beta<- factor(SIRSeq_params_df_3spSHORT_N1grN2grN3$beta, 
...
SIRSeq_params_df_3spLONG_N1grN2grN3<- data.frame(SIRSeq_df, params_combo_3sp_long)

#For SIRS 3sp long ips and imm_dur Na = Nb
SIRSeq_params_df_3spLONG_N1grN2grN3$ips<- 1/SIRSeq_params_df_3spLONG_N1grN2grN3$gamma

SIRSeq_params_df_3spLONG_N1grN2grN3$ips_cat<- round(SIRSeq_params_df_3spLONG_N1grN2grN3$ips)

SIRSeq_params_df_3spLONG_N1grN2grN3$ips_cat[SIRSeq_params_df_3spLONG_N1grN2grN3$ips_cat == 730]<- '730 days infectious'
SIRSeq_params_df_3spLONG_N1grN2grN3$ips_cat[SIRSeq_params_df_3spLONG_N1grN2grN3$ips_cat == 548]<- '548 days infectious'
SIRSeq_params_df_3spLONG_N1grN2grN3$ips_cat[SIRSeq_params_df_3spLONG_N1grN2grN3$ips_cat == 365]<- '365 days infectious'

SIRSeq_params_df_3spLONG_N1grN2grN3$imm_dur<- 1/SIRSeq_params_df_3spLONG_N1grN2grN3$epsilon

SIRSeq_params_df_3spLONG_N1grN2grN3$imm_dur_cat<- round(SIRSeq_params_df_3spLONG_N1grN2grN3$imm_dur)

SIRSeq_params_df_3spLONG_N1grN2grN3$imm_dur_cat[SIRSeq_params_df_3spLONG_N1grN2grN3$imm_dur_cat == 2190]<- '2190 days immune'
SIRSeq_params_df_3spLONG_N1grN2grN3$imm_dur_cat[SIRSeq_params_df_3spLONG_N1grN2grN3$imm_dur_cat == 1643]<- '1643 days immune'
SIRSeq_params_df_3spLONG_N1grN2grN3$imm_dur_cat[SIRSeq_params_df_3spLONG_N1grN2grN3$imm_dur_cat == 1095]<- '1095 days immune'


SIRSeq_params_df_3spLONG_N1grN2grN3$psi_ab_perc<- SIRSeq_params_df_3spLONG_N1grN2grN3$psi_ab*100
SIRSeq_params_df_3spLONG_N1grN2grN3$psi_ac_perc<- SIRSeq_params_df_3spLONG_N1grN2grN3$psi_ac*100
SIRSeq_params_df_3spLONG_N1grN2grN3$psi_bc_perc<- SIRSeq_params_df_3spLONG_N1grN2grN3$psi_bc*100


SIRSeq_params_df_3spLONG_N1grN2grN3$beta<- as.character(SIRSeq_params_df_3spLONG_N1grN2grN3$beta)
SIRSeq_params_df_3spLONG_N1grN2grN3$beta<- factor(SIRSeq_params_df_3spLONG_N1grN2grN3$beta, 
                                                  levels = c('0.0005', '0.0025', '0.005', '0.0075'))
...
save.image(paste(date(), '_SIRS3spN1grN2grN3eqN3.Rdata'))
