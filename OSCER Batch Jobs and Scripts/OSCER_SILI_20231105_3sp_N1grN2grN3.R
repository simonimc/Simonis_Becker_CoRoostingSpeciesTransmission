#---
#title: OSCER_SILI_20231105_3sp_N1grN2grN3
...
SILIeq_params_df_3spSHORT_N1grN2grN3<- data.frame(SILIeq_df, params_combo_3sp_short)

#make ips and imm_durs/latency, and %relatedness, and beta categorical for equilibrium datasets
SILIeq_params_df_3spSHORT_N1grN2grN3$ips<- 1/SILIeq_params_df_3spSHORT_N1grN2grN3$gamma

SILIeq_params_df_3spSHORT_N1grN2grN3$ips_cat<- round(SILIeq_params_df_3spSHORT_N1grN2grN3$ips)

SILIeq_params_df_3spSHORT_N1grN2grN3$ips_cat[SILIeq_params_df_3spSHORT_N1grN2grN3$ips_cat == 7]<- '7 days infectious'
SILIeq_params_df_3spSHORT_N1grN2grN3$ips_cat[SILIeq_params_df_3spSHORT_N1grN2grN3$ips_cat == 5]<- '5 days infectious'
SILIeq_params_df_3spSHORT_N1grN2grN3$ips_cat[SILIeq_params_df_3spSHORT_N1grN2grN3$ips_cat == 3]<- '3 days infectious'


SILIeq_params_df_3spSHORT_N1grN2grN3$lat_dur<- 1/SILIeq_params_df_3spSHORT_N1grN2grN3$epsilon

SILIeq_params_df_3spSHORT_N1grN2grN3$lat_dur_cat<- round(SILIeq_params_df_3spSHORT_N1grN2grN3$lat_dur)

SILIeq_params_df_3spSHORT_N1grN2grN3$lat_dur_cat[SILIeq_params_df_3spSHORT_N1grN2grN3$lat_dur_cat == 90]<- '90 days latent'
SILIeq_params_df_3spSHORT_N1grN2grN3$lat_dur_cat[SILIeq_params_df_3spSHORT_N1grN2grN3$lat_dur_cat == 60]<- '60 days latent'
SILIeq_params_df_3spSHORT_N1grN2grN3$lat_dur_cat[SILIeq_params_df_3spSHORT_N1grN2grN3$lat_dur_cat == 30]<- '30 days latent'


SILIeq_params_df_3spSHORT_N1grN2grN3$psi_ab_perc<- SILIeq_params_df_3spSHORT_N1grN2grN3$psi_ab*100
SILIeq_params_df_3spSHORT_N1grN2grN3$psi_ac_perc<- SILIeq_params_df_3spSHORT_N1grN2grN3$psi_ac*100
SILIeq_params_df_3spSHORT_N1grN2grN3$psi_bc_perc<- SILIeq_params_df_3spSHORT_N1grN2grN3$psi_bc*100


SILIeq_params_df_3spSHORT_N1grN2grN3$beta<- as.character(SILIeq_params_df_3spSHORT_N1grN2grN3$beta)
SILIeq_params_df_3spSHORT_N1grN2grN3$beta<- factor(SILIeq_params_df_3spSHORT_N1grN2grN3$beta, 
...
SILIeq_params_df_3spLONG_N1grN2grN3<- data.frame(SILIeq_df, params_combo_3sp_long)

#For SILI 3sp long ips and lat_dur Na = Nb
SILIeq_params_df_3spLONG_N1grN2grN3$ips<- 1/SILIeq_params_df_3spLONG_N1grN2grN3$gamma

SILIeq_params_df_3spLONG_N1grN2grN3$ips_cat<- round(SILIeq_params_df_3spLONG_N1grN2grN3$ips)

SILIeq_params_df_3spLONG_N1grN2grN3$ips_cat[SILIeq_params_df_3spLONG_N1grN2grN3$ips_cat == 730]<- '730 days infectious'
SILIeq_params_df_3spLONG_N1grN2grN3$ips_cat[SILIeq_params_df_3spLONG_N1grN2grN3$ips_cat == 548]<- '548 days infectious'
SILIeq_params_df_3spLONG_N1grN2grN3$ips_cat[SILIeq_params_df_3spLONG_N1grN2grN3$ips_cat == 365]<- '365 days infectious'

SILIeq_params_df_3spLONG_N1grN2grN3$lat_dur<- 1/SILIeq_params_df_3spLONG_N1grN2grN3$epsilon

SILIeq_params_df_3spLONG_N1grN2grN3$lat_dur_cat<- round(SILIeq_params_df_3spLONG_N1grN2grN3$lat_dur)

SILIeq_params_df_3spLONG_N1grN2grN3$lat_dur_cat[SILIeq_params_df_3spLONG_N1grN2grN3$lat_dur_cat == 2190]<- '2190 days latent'
SILIeq_params_df_3spLONG_N1grN2grN3$lat_dur_cat[SILIeq_params_df_3spLONG_N1grN2grN3$lat_dur_cat == 1643]<- '1643 days latent'
SILIeq_params_df_3spLONG_N1grN2grN3$lat_dur_cat[SILIeq_params_df_3spLONG_N1grN2grN3$lat_dur_cat == 1095]<- '1095 days latent'


SILIeq_params_df_3spLONG_N1grN2grN3$psi_ab_perc<- SILIeq_params_df_3spLONG_N1grN2grN3$psi_ab*100
SILIeq_params_df_3spLONG_N1grN2grN3$psi_ac_perc<- SILIeq_params_df_3spLONG_N1grN2grN3$psi_ac*100
SILIeq_params_df_3spLONG_N1grN2grN3$psi_bc_perc<- SILIeq_params_df_3spLONG_N1grN2grN3$psi_bc*100


SILIeq_params_df_3spLONG_N1grN2grN3$beta<- as.character(SILIeq_params_df_3spLONG_N1grN2grN3$beta)
SILIeq_params_df_3spLONG_N1grN2grN3$beta<- factor(SILIeq_params_df_3spLONG_N1grN2grN3$beta, 
                                                  levels = c('0.0005', '0.0025', '0.005', '0.0075'))
...
save.image(paste(date(), '_SILI3spN1grN2grN3eqN3.Rdata'))
